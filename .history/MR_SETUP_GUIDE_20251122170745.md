...
2. [Шаг 1: Запуск PostgreSQL](#шаг-1-запуск-postgresql)
3. [Шаг 2: Проверка подключения](#шаг-2-проверка-подключения)
4. [Шаг 3: Сбор Merge Requests](#шаг-3-сбор-merge-requests)
5. [Шаг 4: Импорт в базу данных](#шаг-4-импорт-в-базу-данных)
6. [Шаг 5: Проверка данных](#шаг-5-проверка-данных)
7. [Шаг 6: Использование в сессиях](#шаг-6-использование-в-сессиях)
